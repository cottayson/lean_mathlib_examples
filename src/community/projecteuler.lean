...
-- Solutions on haskell:
-- https://github.com/Rotsor/euler
...
-- Eating Pie https://projecteuler.net/problem=394
-- An infinite game https://projecteuler.net/problem=664
-- First Sort I https://projecteuler.net/problem=523